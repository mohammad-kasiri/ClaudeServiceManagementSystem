...
//            'authority'     => $response->Authority,
            'authority'     => '4F7123863A9CBB118FCADA0C9E0CAEAC',
//            'paymentUrl'    => $response->PaymentUrl,
            'paymentUrl'    => 'https://panispay.com/startPay/4F7123863A9CBB118FCADA0C9E0CAEAC',
//            'PaymentForm'   => $response->PaymentForm,
            'PaymentForm'   => 'PHNjcmlwdCBsYW5ndWFnZT0namF2YXNjcmlwdCc+d2luZG93LmxvY2F0aW9uLmhyZWYgPSAnaHR0cHM6Ly9wYW5pc3BheS5jb20vc3RhcnRQYXkvNEY3MTIzODYzQTlDQkIxMThGQ0FEQTBDOUUwQ0FFQUMnOzwvc2NyaXB0Pg==',
            'BuyerIP'       => request()->ip(),
        ]);

        //return redirect()->to($gateway->paymentUrl);
        return redirect()->route('callback', ['invoice' => $invoice->id]);
    }
